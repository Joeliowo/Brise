...
public class EntityAIMultiProtectionFuse<P extends EntityGem, M extends EntityGem, F extends EntityFusionGem> extends EntityAIBase {
    private EntityGem initiator;
    private Class<P> passive;
    private Class<M> other;
    private Class<F> result;
    private P target;
    private double size;

    public <T extends EntityGem> EntityAIMultiProtectionFuse(EntityGem initiator, Class<M> other, Class<P> passive, Class<F> result, double size) {
