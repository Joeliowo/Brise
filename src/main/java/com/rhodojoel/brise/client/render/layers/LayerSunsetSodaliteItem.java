...
public class LayerSunsetSodaliteItem implements LayerRenderer<EntitySunsetSodalite> {
    protected final RenderLivingBase<EntitySunsetSodalite> livingEntityRenderer;
    public LayerSunsetSodaliteItem(RenderLivingBase<EntitySunsetSodalite> livingEntityRendererIn) {
        this.livingEntityRenderer = livingEntityRendererIn;
    }
    public void doRenderLayer(EntitySunsetSodalite entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    private void renderHeldItem(EntitySunsetSodalite entity, ItemStack stack, ItemCameraTransforms.TransformType camera, EnumHandSide handSide) {
    	if (!stack.isEmpty()) {
            GlStateManager.pushMatrix();
