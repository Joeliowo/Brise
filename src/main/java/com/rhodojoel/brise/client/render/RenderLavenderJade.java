...
public class RenderLavenderJade extends RenderGemBase<EntityLavenderJade> {
	public RenderLavenderJade() {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityLavenderJade entity) {
		return new ResourceLocation("brise:textures/entities/lavenderjade/lavenderjade.png");
	}
}