...
import com.rhodojoel.brise.gem.EntityWhiteJade;
...
public class RenderWhiteJade extends RenderGemBase<EntityWhiteJade> {
	public RenderWhiteJade() {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityWhiteJade entity) {
		return new ResourceLocation("brise:textures/entities/whitejade/whitejade.png");
	}
}