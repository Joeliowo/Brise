 ...
 */
public class ModelPossessedAgate extends ModelGem {
    ...
    public ModelPossessedAgate() {
        ...
        this.hairnubtop = new ModelRenderer(this, 0, 48);
        this.hairnubtop.setRotationPoint(2.0F, -4.5F, 2.0F);
        this.hairnubtop.addBox(0.0F, 0.0F, 0.0F, 4, 4, 4, 0.0F);
        ...
        this.harinub1 = new ModelRenderer(this, 0, 56);
        this.harinub1.setRotationPoint(-5.0F, 2.0F, 2.0F);
        this.harinub1.addBox(0.0F, 0.0F, 0.0F, 5, 4, 4, 0.0F);
        this.hairnubback = new ModelRenderer(this, 16, 38);
        this.hairnubback.setRotationPoint(2.0F, 2.0F, 8.3F);
        this.hairnubback.addBox(0.0F, 0.0F, 0.0F, 4, 4, 4, 0.0F);
        ...
        this.hairnub2 = new ModelRenderer(this, 0, 56);
        this.hairnub2.setRotationPoint(8.0F, 2.0F, 2.0F);
        this.hairnub2.addBox(0.0F, 0.0F, 0.0F, 5, 4, 4, 0.0F);
        ...
        this.head.addChild(this.hairnubtop);
        this.arm1pt1.addChild(this.arm1pt2);
        this.Body.addChild(this.arm1pt1);
        this.head.addChild(this.harinub1);
        this.head.addChild(this.hairnubback);
        this.head.addChild(this.hairnub2);
