 ...
 */
public class ModelPossessedPearl extends ModelGem {
    ...
    public ModelPossessedPearl() {
        super(0, 0, 64, 64, false, 7F);
        ...
        this.Nose = new ModelRenderer(this, 36, 16);
        this.Nose.setRotationPoint(3.5F, 4.0F, -2.0F);
        this.Nose.addBox(0.0F, 1.0F, 0.0F, 1, 1, 2, 0.0F);
