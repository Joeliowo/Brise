...
public class EntityDestabalizer extends Entity {
    public EntityLivingBase shootingEntity;
    public int explosionPower;
    public double accelerationX;
    public double accelerationY;
    public double accelerationZ;
    public EntityDestabalizer(World worldIn) {
        super(worldIn);
    ...
    public EntityDestabalizer(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ, int explosionPower) {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityDestabalizer(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ, int explosionPower) {
        super(worldIn);
    ...
    protected void onImpact(RayTraceResult result) {
        if (!this.world.isRemote) {
            if (result.entityHit != null) {
                if(result.entityHit instanceof EntityGem){
                    ((EntityGem) result.entityHit).setHealth(0);
                }
            }
        }
    }
