...
public class EntityMultiFusionGem  extends EntityGem {
    ...
    protected static final DataParameter<String> FUSION_TYPES = EntityDataManager.<String>createKey(EntityMultiFusionGem.class, DataSerializers.STRING);
    protected static final DataParameter<Integer> DEFECTIVE_COUNT = EntityDataManager.<Integer>createKey(EntityMultiFusionGem.class, DataSerializers.VARINT);
    protected static final DataParameter<Integer> PRIME_COUNT = EntityDataManager.<Integer>createKey(EntityMultiFusionGem.class, DataSerializers.VARINT);
    protected static final DataParameter<Integer> FUSION_COLOR = EntityDataManager.<Integer>createKey(EntityMultiFusionGem.class, DataSerializers.VARINT);

    public EntityMultiFusionGem(World world) {
        super(world);
    ...
    public boolean addGem(EntityGem gem) {
        ...
        this.setFusionPlacements(this.generateFusionPlacements());
        this.setFusionTypes(this.generateFusionTypes());
        this.pitch = (this.pitch + gem.getSoundPitch()) / this.getFusionCount();
        return true;
    }
